...
public class projet {
	...
	public static void main(String[] args) {
		...
		synthetyzeToFile(context, "Exo1/distributionNotidle.txt", statNotIdle, percentilesNotIdle, histogramNotIdle, nTranches);
		...
		synthetyzeToFile(context, "Exo1/distributionIdle.txt", statIdle, percentilesIdle, histogramIdle, nTranches);
		...
		for(Tuple2<String, Iterable<String>> aPattern : groupBySinglePatternCollect) {
			...
			synthetyzeToFile(context, "Exo1/distributionUniquePattern" + aPattern._1 + ".txt", aPatternDurationStat, aPatternDurationPercentiles, aPatternDurationHistogram, nTranches);
		}
